// LibAFL 0.11(可能)后bolts弃用,使用了一个新的库libafl_bolts,toml需要添加依赖
...
use libafl::{feedback_or, Error, Fuzzer, StdFuzzer};
...
fn main() -> Result<(), Error> {
    ...
    let timeouts_corpus = OnDiskCorpus::new(PathBuf::from("./crash_output"))?;
